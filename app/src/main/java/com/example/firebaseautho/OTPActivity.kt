...
//    private lateinit var verifybnt: Button
...
//    private lateinit var opt5: EditText
//    private lateinit var opt6: EditText
...
//            resendOTPTvVisibility()
//        }
//        verifybnt.setOnClickListener{
//            val typedOTP:String= (opt1.text.toString()+opt2.text.toString()+opt3.text.toString()+
//                    opt4.text.toString()+opt5.text.toString()+opt6.text.toString())
...
//            }else{
//                Toast.makeText(this,"Please Fill all OTP!",Toast.LENGTH_SHORT).show()
//            }
//
//        }
//
...
//        opt1.addTextChangedListener(EditTextWatcher(opt1))
//        opt2.addTextChangedListener(EditTextWatcher(opt2))
//        opt3.addTextChangedListener(EditTextWatcher(opt3))
//        opt4.addTextChangedListener(EditTextWatcher(opt4))
//        opt5.addTextChangedListener(EditTextWatcher(opt5))
//        opt6.addTextChangedListener(EditTextWatcher(opt6))
//
//    }
//
//    private fun init() {
//        firebaseAuth = FirebaseAuth.getInstance()
//        verifybnt = findViewById(R.id.verifyOTPBtn)
//        resendtv = findViewById(R.id.resendTextView)
//        opt1 = findViewById(R.id.otpEditText1)
//        opt2 = findViewById(R.id.otpEditText2)
//        opt3 = findViewById(R.id.otpEditText3)
//        opt4 = findViewById(R.id.otpEditText4)
//        opt5 = findViewById(R.id.otpEditText5)
//        opt6 = findViewById(R.id.otpEditText6)
//
//    }
//
...
//            val text = s.toString()
//            when (view.id) {
//                R.id.otpEditText1 -> if (text.length == 1) opt2.requestFocus()
//                R.id.otpEditText2 -> if (text.length == 1) opt3.requestFocus() else if (text.isEmpty()) opt1.requestFocus()
//                R.id.otpEditText3 -> if (text.length == 1) opt4.requestFocus() else if (text.isEmpty()) opt2.requestFocus()
//                R.id.otpEditText4 -> if (text.length == 1) opt5.requestFocus() else if (text.isEmpty()) opt3.requestFocus()
//                R.id.otpEditText5 -> if (text.length == 1) opt6.requestFocus() else if (text.isEmpty()) opt4.requestFocus()
//                R.id.otpEditText6 -> if (text.isEmpty()) opt5.requestFocus()
//            }
//        }
//    }
//}
